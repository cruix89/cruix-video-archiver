...
if [ -d "$downloads_dir" ]; then
  ...
  echo -e "[cruix-video-archiver-hvec] Executing FFMPEG Process In The Video Library..."
  ...
  echo -e "[cruix-video-archiver-hvec] Oops! Output Directory Not Found: $downloads_dir "
fi